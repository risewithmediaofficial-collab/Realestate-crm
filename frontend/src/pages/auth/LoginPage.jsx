...
import { Eye, EyeOff, Building2, Lock, User, Mail, Phone, MapPin, ArrowRight, AlertCircle, CheckCircle2, Clock, ShieldCheck, HelpCircle, Check, ArrowLeft } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    if (res.success) {
      ...
      if (res.pendingApproval) {
        setError('⏳ Account Approval Pending: Your workspace registration is currently awaiting verification and approval. You will be able to log in once approved.');
      } else if (res.rejected) {
        setError(res.message || 'Your account registration was rejected. Please contact support or administrator.');
      } else {
  ...
  return (
    <div className="auth-page" style={{ minHeight: '100vh', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', background: '#0b132b', padding: '20px 16px', overflowY: 'auto', overflowX: 'hidden', boxSizing: 'border-box' }}>
        ...
        {pendingApprovalSuccess ? (
          <div style={{
            ...
            <p style={{ fontSize: 13, color: '#475569', lineHeight: 1.5, marginBottom: 16 }}>
              Your workspace registration for <strong>{registeredOrg}</strong> is now submitted for verification and account activation. Once approved, you will be able to log in with your email (<strong>{registeredEmail}</strong>) and password.
            </p>
            ...
            <div style={{
              ...
              <ShieldCheck size={16} color="#d97706" /> Account verification and approval is required for all new workspaces.
            </div>
          ...
          <>
            <div style={{ marginBottom: 20 }}>
              ...
              <p className="auth-subtitle" style={{ fontSize: 13, color: '#64748b' }}>
                {mode === 'login' ? 'Enter your credentials to access your CRM workspace' : 'Create an organization workspace to manage leads, inventory & bookings (Requires verification & approval)'}
              </p>
            </div>
          ...
          <form onSubmit={handleRegisterSubmit}>
            ...
            <div className="auth-grid-2">
              <div className="form-group">
                <label className="form-label" style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#334155', marginBottom: 4 }}>
                  Organization / Agency Name <span style={{ color: '#ef4444' }}>*</span>
                </label>
                <div style={{ position: 'relative' }}>
            ...
            <div className="auth-grid-2" style={{ marginBottom: 14 }}>
              <div className="form-group">
                <label className="form-label" style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#334155', marginBottom: 4 }}>
